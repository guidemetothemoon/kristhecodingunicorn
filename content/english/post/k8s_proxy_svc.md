...
> Please note that you need to use the ```kubernetes.io/service-name: <your-service-name>``` annotation in order for the Service to be mapped to the Endpoint automatically.
