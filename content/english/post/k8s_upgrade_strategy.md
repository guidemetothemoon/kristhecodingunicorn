...
- **Support policy.** Last reason is related to support policy defined by cloud provider which is applicable if you're using managed Kubernetes service. When it comes to managed Kubernetes service like AKS it's important to understand what you're responsible for in terms of keeping your AKS clusters and nodes upgraded:
